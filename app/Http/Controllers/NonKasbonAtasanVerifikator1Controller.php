...
class NonKasbonAtasanVerifikator1Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Kasbon';
        return view('vnk-atasan-verifikator-1.index', compact('nonkasbon', 'title'))->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    public function show($id)
    {
        ...
        $title = 'Non Kasbon';
        return view('vnk-atasan-verifikator-1.lihat-nonkasbon', compact('nonkasbon', 'title'));
    }
    ...
    public function kelengkapan($id)
    {
        $nonkasbon = nonkasbon::find($id);
        $title = 'Non Kasbon';
        return view('vnk-atasan-verifikator-1.lihat-kelengkapan', compact('nonkasbon', 'title'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $id) {
            ...
            if ($nonkasbon->k_total > 0 && $nonkasbon->k_total <= 20000000) {
                ...
                } elseif ($nonkasbon->verifikasinonkasbon->vnk_a_2 = $request->Input('status') == 'Ditolak') {
                    $nonkasbon->verifikasinonkasbon->vnk_a_2 = $request->Input('status');
            ...
            } elseif ($nonkasbon->k_total > 20000000) {
                if ($nonkasbon->verifikasinonkasbon->vnk_a_2 = $request->Input('status') == 'Terverifikasi') {
                    $nonkasbon->verifikasinonkasbon->vnk_a_2 = $request->Input('status');
        ...
        return redirect()->route('vnk-atasan-verifikator-1.index')->with('success', 'User updated successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vnk-atasan-verifikator-1.index')->with('success', 'Non Kasbon updated successfully');
    }
}
