                ...
                <div class="card-body" id="form1">
                         ...
                         <div class="card-body">
                                 <div class="row">
                                         ...
                                         <div class="col-md-2">
                                             ...
                                             <div class="form-check">
                                                 <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist1" value="ASLI" {{ ($pertanggungan->kasbon->kelengkapan->dvendor->dv_packcinglist=="ASLI")? "checked" : "" }}>
                                                 <label class="form-check-label" for="dv_packinglist1">
                                                     ASLI
                                                 </label>
                                             </div>
                                             <div class="form-check">
                                                 <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist2" value="COPY" {{ ($pertanggungan->kasbon->kelengkapan->dvendor->dv_packcinglist=="COPY")? "checked" : "" }}> 
                                                 <label class="form-check-label" for="dv_packinglist2">
                                                     COPY
                                                 </label>
                                             </div>
                                             <div class="form-check">
                                                 <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist2" value="-" {{ ($pertanggungan->kasbon->kelengkapan->dvendor->dv_packcinglist=="-")? "checked" : "" }}>
                                                 <label class="form-check-label" for="dv_packinglist2">
                                                     -
                                                 </label>
                                             </div>
                 ...
                 <div class="col-lg-12">
                     <div class="card">
                        ...
                        <input value="{{$pertanggungan->kasbon->id}}" class="text-muted mb-0" name="id" hidden> 
                           ...
                           @foreach ($pertanggungan->kasbon->kelengkapan->keterangan->keterangan_detail as $detail)
                             <tr>
                               ...
                               <td >
                                   ...
                                   <input type="date" name="tgl_kelengkapan[]" id="" class="form-control" value="{{ $detail->tgl_kelengkapan ? \Carbon\Carbon::parse($detail->tgl_kelengkapan)->format('Y-m-d') : '' }}" >
                               </td>
