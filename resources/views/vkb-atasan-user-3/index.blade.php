                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($kasbon as $kasbon)
                                     @if(isset($kasbon->verifikasikasbon->vkb_a_13))
                                <tr>
                                    ...
                                    <td>
                                        @if($kasbon->verifikasikasbon->vkb_a_13 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Belum Proses</label>
                                        @elseif($kasbon->verifikasikasbon->vkb_a_13 == "Terverifikasi")
                                        ...
                                        @endif
                                        @elseif($kasbon->verifikasikasbon->vkb_a_13 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">Ditolak</label>
                                        @elseif($kasbon->verifikasikasbon->vkb_a_13 == "Revisi")
                                    ...
                                    <td>
                                        @if(isset($kasbon->verifikasikasbon->id_vkb_a_13))
                                            @if($kasbon->verifikasikasbon->vkb_a_13 == "Dalam Proses")
                                                @include('vkb-atasan-user-3.modal-cek-edit')
                                                <a  href="{{ route('vkb-atasan-user-3.show',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                                <a href="{{ route('vkb-atasan-user-3.kelengkapan',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="List Kelengkapan"><i class="mdi mdi-file-document" style="font-size: 150%; "></i></a>
                                                <a href="{{ route('vkb-atasan-user-3.dokumen',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Lampiran"><i class="mdi mdi-file-pdf" style="font-size: 150%; "></i></a>
                                        ...
                                        @else
                                            @if($kasbon->verifikasikasbon->vkb_a_13 == "Dalam Proses")
                                                ...
                                                <a href="{{ route('vkb-atasan-user-3.kelengkapan',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="List Kelengkapan"><i class="mdi mdi-file-document" style="font-size: 150%; "></i></a>
                                                <a href="{{ route('vkb-atasan-user-3.dokumen',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Lampiran"><i class="mdi mdi-file-pdf" style="font-size: 150%; "></i></a>
                                                @include('vkb-atasan-user-3.modal-cek')
