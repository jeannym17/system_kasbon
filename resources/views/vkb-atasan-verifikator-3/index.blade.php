                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    @if(isset($kasbon->verifikasikasbon->vkb_a_4))
                                <tr>
                                    ...
                                    <td>
                                        @if($kasbon->verifikasikasbon->vkb_a_4 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Belum Proses</label>
                                        @elseif($kasbon->verifikasikasbon->vkb_a_4 == "Terverifikasi")
                                        ...
                                        @endif
                                        @elseif($kasbon->verifikasikasbon->vkb_a_4 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">Ditolak</label>
                                        @elseif($kasbon->verifikasikasbon->vkb_a_4 == "Revisi")
