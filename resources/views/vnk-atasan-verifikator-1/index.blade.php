                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @if(isset($nonkasbon->verifikasinonkasbon->vnk_a_2))
                                <tr>
                                    ...
                                    <td>
                                    @if($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Dalam Proses")
                                    ...
                                    <td>
                                        @if($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Dalam Proses")
                                        <a  href="{{ route('vnk-atasan-verifikator-1.show',$nonkasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Non Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                        @include('vnk-atasan-verifikator-1.modal-cek-edit')
                                        <a type="button" data-bs-toggle="modal" data-bs-target="#modalcekedit_{{$nonkasbon->id}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Verifikasi"><i class="mdi mdi-checkbox-marked-outline" style="font-size: 150%; "></i></a>
                                        @else
                                        <a  href="{{ route('vnk-atasan-verifikator-1.show',$nonkasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Non Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                        @endif
                                    </td>
