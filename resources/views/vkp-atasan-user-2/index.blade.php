                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    @if(isset($pertanggungan->verifikasipertanggungan->vkp_a_12))
                                <tr>
                                    ...
                                    <td>
                                        @if($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Dalam Proses")
                                    ...
                                    <td>
                                        @if(isset($pertanggungan->verifikasipertanggungan->vkp_a_12))
                                        @if($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Dalam Proses")
                                            @include('vkp-atasan-user-2.modal-cek')
                                            <a href="{{ route('vkp-atasan-user-2.show_v',$pertanggungan->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Pertanggungan"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                            <a href="{{ route('vkp-atasan-user-2.kelengkapan_v',$pertanggungan->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="List Kelengkapan"><i class="mdi mdi-file-document" style="font-size: 150%; "></i></a>
