                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Ditolak")
                                    ...
                                    <td>
                                            @if($kasbon->verifikasikasbon->vkb_a_1 == "Dalam Proses")
                                            <a  href="{{ route('vkb-atasan-user-1.show',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                            <a href="{{ route('vkb-atasan-user-1.kelengkapan',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="List Kelengkapan"><i class="mdi mdi-file-document" style="font-size: 150%; "></i></a>
                                            <a href="{{ route('vkb-atasan-user-1.dokumen',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Lampiran"><i class="mdi mdi-file-pdf" style="font-size: 150%; "></i></a>
                                            @include('vkb-atasan-user-1.modal-cek-edit')
