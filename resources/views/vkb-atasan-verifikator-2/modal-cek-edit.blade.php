        ...
        <div class="modal-dialog modal-xl"  >
            <div class="modal-content" >
                ...
                <div class="modal-body step-1" data-step="1" >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive shopping-cart" >
                                        ...
                                        <td class="text-dark"><strong>{{$kasbon->kelengkapan->keterangan->catatan}}</strong></td>
                                    </tr>  
                                </tbody>
                            </table>
                                </div>
                    ...
                    {!! Form::model($kasbon, ['method' => 'PATCH','route' => ['vkb-atasan-verifikator-2.update', $kasbon->id],'class' => 'form-parsley']) !!}
