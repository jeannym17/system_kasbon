                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @if(isset($nonkasbon->verifikasinonkasbon->vnk_a_12))
                                <tr>
                                    ...
                                    <td>
                                    @if($nonkasbon->verifikasinonkasbon->vnk_a_12 == "Dalam Proses")
                                    ...
                                    <td>
                                        @if($nonkasbon->verifikasinonkasbon->vnk_a_12 == "Dalam Proses")
                                        <a  href="{{ route('vnk-atasan-user-2.show',$nonkasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Non Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                        @include('vnk-atasan-user-2.modal-cek-edit')
