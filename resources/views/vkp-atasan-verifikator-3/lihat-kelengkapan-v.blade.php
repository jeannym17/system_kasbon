            ...
            <div class="row">
                                ...
                                <table>
                                    <tbody>
                                      ...
                                      <tr>
                                       ...
                                       <tr>
                                        <td colspan="6"class="tm_border_top tm_border_right"><b class="tm_primary_color">CATATAN : {{$pertanggungan->kasbon->kelengkapan->keterangan->catatan ?? '-'}} </b></td>
                                    </tr>
                                    <tr>
                                    ...
                                    @foreach ($pertanggungan->kasbon->kelengkapan->keterangan->keterangan_detail as $details)
                                    <tr>
                ...
                <div class="row">
                  <div class="col-sm-12 text-end">
                      <a href="{{ route('vkp-atasan-verifikator-3.index') }}" type="button" class="btn btn-danger px-4">Back</a>
                  </div>
              </div>
            </div>
