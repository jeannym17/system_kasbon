...
@endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_2') Monitoring Pertanggungan @endslot
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable2" class="table dt-responsive"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    <th hidden></th>
                                    <th rowspan="2">No Pertanggungan</th>
                                ...
                                <tr  style="text-align: center">
                                    <td hidden>{{$pertanggungan->updated_at}}</td>
                                    <td>{{$pertanggungan->nokasbon}}</td>
                                    <td>{{$pertanggungan->created_at->format('m/d/Y')}}</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_1 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_1->format('m/d/Y')  : '-' }}</td>
                                    <td> @if($pertanggungan->verifikasipertanggungan->vkp_a_1 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">{{$pertanggungan->verifikasipertanggungan->vkp_a_1 ?? '-'}}</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_1 == "Revisi")
                                        <label class="badge rounded-pill bg-warning">{{$pertanggungan->verifikasipertanggungan->vkp_a_1 ?? '-'}}</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_1 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">{{$pertanggungan->verifikasipertanggungan->vkp_a_1 ?? '-'}}</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_1 == "Terverifikasi")
                                        <label class="badge rounded-pill bg-success">{{$pertanggungan->verifikasipertanggungan->vkp_a_1 ?? '-'}}</label>
                                        @else
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_12 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_12->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Revisi")
                                        <label class="badge rounded-pill bg-warning">Revisi</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">Ditolak</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_12 == "Terverifikasi")
                                        <label class="badge rounded-pill bg-success">Terverifikasi</label>
                                        @else
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_13 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_13->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp_a_13 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    ...
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_13 == "Terverifikasi")
                                        ...
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp ? $pertanggungan->verifikasipertanggungan->tgl_vkp->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    ...
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp == "Terverifikasi")
                                        ...
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_2 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_2->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Revisi")
                                        <label class="badge rounded-pill bg-warning">Revisi</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">Ditolak</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Terverifikasi")
                                        <label class="badge rounded-pill bg-success">Terverifikasi</label>
                                        @else
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_3 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_3->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Revisi")
                                        <label class="badge rounded-pill bg-warning">Revisi</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Ditolak")
                                        <label class="badge rounded-pill bg-danger">Ditolak</label>
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Terverifikasi")
                                        <label class="badge rounded-pill bg-success">Terverifikasi</label>
                                        @else
                                        -
                                    @endif</td>
                                    <td>{{$pertanggungan->verifikasipertanggungan->tgl_vkp_a_4 ? $pertanggungan->verifikasipertanggungan->tgl_vkp_a_4->format('m/d/Y')  : '-' }}</td>
                                    <td>@if($pertanggungan->verifikasipertanggungan->vkp_a_4 == "Dalam Proses")
                                        <label class="badge rounded-pill bg-primary">Dalam Proses</label>
                                    ...
                                    @elseif($pertanggungan->verifikasipertanggungan->vkp_a_4 == "Terverifikasi")
                                        ...
                                        -
                                    @endif</td>
                                    <td> @include('mkp.modal-cek-lihat')  <a data-bs-toggle="modal" data-bs-target="#modalceklihat_{{$pertanggungan->id}}" class="btn btn-primary btn-sm"><i class="mdi mdi-information-outline"></i></a> </td>
                                    @endforeach
                                </tr>
