          ...
          <div class="tm_invoice_head ">
            <div class="tm_invoice_left">
              <p  style="font-size: 11px " ><b class="tm_primary_color" >
                ...
                NOMINAL KASBON &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;{{$pertanggungan->kasbon->kurs->symbol}} {{number_format($pertanggungan->kasbon->total)}} <br>
				NOMINAL REALISASI	&nbsp;&nbsp;&nbsp;:&nbsp; {{$pertanggungan->kasbon->kurs->symbol}} {{number_format($pertanggungan->nilaiptj)}}<br>
                SELISIH REALISASI	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; {{$pertanggungan->kasbon->kurs->symbol}} {{number_format($pertanggungan->selisihptj)}}<br>
				PERTANGGUNGAN
				</b>
              </p>
            </div>
