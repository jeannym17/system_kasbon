                      ...
                      <div class="col-sm-12">
                          <div class="card form-wizard-wrapper">
                              <div class="card-header">
                                  ...
                                  <h4 class="card-title" id="4-form-entry">Form Entry Rencana / Realisasi 4</h4>
                              </div><!--end card-header-->
                              <div class="card-body">
                                  <form action="{{ route('kasbon.store') }}" name="myform" id="myform" method="post" class="myform form-parsley" enctype="multipart/form-data" onsubmit="return validateForm()">
                                      {{ csrf_field() }}
                                     @include('kasbon.entry-1')
                                     @include('kasbon.entry-2')
                                     @include('kasbon.entry-3')
                                     @include('kasbon.entry-4')
                                  </form>   
                              </div><!--end card-body-->
                          </div><!--end card-->
                      </div><!--end col-->
